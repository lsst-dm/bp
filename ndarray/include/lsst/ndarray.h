 ...
 *
 * @section overview_views Indexing and Views
 ...
 * This is a customized version of ndarray intended for the Large Synoptic Survey Telescope
 * project.  The main %ndarray distributiono can be found at:
