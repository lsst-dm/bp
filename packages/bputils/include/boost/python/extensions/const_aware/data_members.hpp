...
#ifndef BOOST_PYTHON_EXTENSIONS_CONST_AWARE_DATA_MEMBERS_HPP
#define BOOST_PYTHON_EXTENSIONS_CONST_AWARE_DATA_MEMBERS_HPP

#include "boost/python.hpp"
#include "boost/python/extensions/const_aware/as_const.hpp"
#include "boost/type_traits/is_array.hpp"
#include "boost/type_traits/is_pointer.hpp"

namespace boost { namespace python { namespace extensions {

template <typename W> class const_aware;
...
public:
    ...
    void visit(class_<const_aware<V>,T1,T2,T3> & wrapper) const {
...
#endif // !BOOST_PYTHON_EXTENSIONS_CONST_AWARE_DATA_MEMBERS_HPP
