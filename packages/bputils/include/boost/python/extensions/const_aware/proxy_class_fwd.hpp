...
#ifndef BOOST_PYTHON_EXTENSIONS_CONST_AWARE_PROXY_CLASS_FWD_HPP
#define BOOST_PYTHON_EXTENSIONS_CONST_AWARE_PROXY_CLASS_FWD_HPP
...
#endif // !BOOST_PYTHON_EXTENSIONS_CONST_AWARE_PROXY_CLASS_FWD_HPP
