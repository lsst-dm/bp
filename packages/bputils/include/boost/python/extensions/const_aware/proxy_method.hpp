...
#ifndef BOOST_PYTHON_EXTENSIONS_CONST_AWARE_PROXY_METHOD_HPP
#define BOOST_PYTHON_EXTENSIONS_CONST_AWARE_PROXY_METHOD_HPP
...
#endif // !BOOST_PYTHON_EXTENSIONS_CONST_AWARE_PROXY_METHOD_HPP
