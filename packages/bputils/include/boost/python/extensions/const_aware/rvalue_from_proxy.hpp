...
#ifndef BOOST_PYTHON_EXTENSIONS_CONST_AWARE_RVALUE_FROM_PROXY_HPP
#define BOOST_PYTHON_EXTENSIONS_CONST_AWARE_RVALUE_FROM_PROXY_HPP
...
#endif // !BOOST_PYTHON_EXTENSIONS_CONST_AWARE_RVALUE_FROM_PROXY_HPP
