...
#ifndef BOOST_PYTHON_EXTENSIONS_CONST_CAST_SHARED_PTR_HPP
#define BOOST_PYTHON_EXTENSIONS_CONST_CAST_SHARED_PTR_HPP
 ...
 *
 *  This converter is particularly useful when a wrapped class is immutable in Python, so there's
 *  no need to use the more complex const_aware functionality.
 */
...
#endif // !BOOST_PYTHON_EXTENSIONS_CONST_CAST_SHARED_PTR_HPP
