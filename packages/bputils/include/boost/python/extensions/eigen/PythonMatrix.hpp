#ifndef BOOST_PYTHON_EXTENSIONS_EIGEN_PYTHONMATRIX_HPP_INCLUDED
#define BOOST_PYTHON_EXTENSIONS_EIGEN_PYTHONMATRIX_HPP_INCLUDED
...
public:
    ...
    explicit PythonMatrix(boost::python::extensions::numpy::matrix const & py) : _py(py) {
        ...
        if (_py.get_dtype() != boost::python::extensions::numpy::dtype::get_builtin<_Scalar>()) {
    ...
    boost::python::extensions::numpy::matrix getPyObject() const { return _py; }

private:
    boost::python::extensions::numpy::matrix _py;
};
    ...
    : public detail::builtin_to_python
{
    inline PyObject * operator()(Eigen::PythonMatrix<_Scalar,_Rows,_Cols> const & x) const {
        extensions::numpy::matrix obj(x.getPyObject());
        Py_INCREF(obj.ptr());
        return obj.ptr();
    }
...
#endif // !BOOST_PYTHON_EXTENSIONS_EIGEN_PYTHONMATRIX_HPP_INCLUDED
