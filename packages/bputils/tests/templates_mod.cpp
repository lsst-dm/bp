...
struct ArrayFiller {
    ...
    bpx::numpy::ndarray argument;

    explicit ArrayFiller(bpx::numpy::ndarray const & arg) : argument(arg) {}

};

void fill(bpx::numpy::ndarray const & arg) {
    ArrayFiller filler(arg);
    bpx::numpy::invoke_matching_array< ArrayFiller::TypeSequence, ArrayFiller::DimSequence >(arg, filler);
}
